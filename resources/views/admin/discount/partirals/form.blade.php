...
<div class="row form-group">
    <div class="col col-md-3">
        <label for="count_buy" class=" form-control-label">{{__('Количесво покупок')}}</label>
    </div>
    <div class="col-12 col-md-9">
        ...
        <small class="form-text text-info">{{__('Заполнять если необходимо автоматически актевировать скидку после определенного количества покупок')}}</small>
